...
**Focus Areas:** Smart contract audits, Network penetration testing, Cryptographic implementations, Zero-knowledge proofs
...
- 🔐 **Security First** — Write audited, battle-tested code with a zero-trust mindset
- 🌍 **Decentralization** — Build systems that distribute power and control fairly
- 🤖 **AI-Enhanced** — Leverage AI to make blockchain more accessible and intelligent
...
[![YouTube](https://img.shields.io/badge/-YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@amiya.all-all)
